...
import {
  earningData, SparklineAreaData, } from '../data/dummy';
  ...
  return (
    <div className='mt-12 '>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        <div className='flex m-3 flex-warp justify-center gap-1 items-center '>
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780 '>
          <div className='flex justify-between'>
            ...
            <div className='flex items-center gap-4'>
              <p className="flex items-center gap-2 text-gray-600 hover:drop-shadow-x">
                <span>
                  {/* <GoPrimitiveDot/> */}
                </span>
                <span>Expense</span>
          ...
          <div className='className="mt-10 flex gap-10 flex-wrap justify-center'>
